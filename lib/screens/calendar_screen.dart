          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                    ...
                    child: TableCalendar(
                      ...
                      eventLoader: (day) {
                        ...
                        if (event != null && isSameDay(day, event.date)) {
                          return [context.isGerman ? 'Stammtisch' : 'Event'];
                        }
                        return [];
                      },
                              ...
                              children: [
                                ...
                                Text(
                                  event.isConfirmed 
                                      ...
                                      : (context.isGerman ? '❌ Nicht bestätigt' : '❌ Not confirmed'),
                                  style: TextStyle(
                ...
                // Events List with Stats - mit fixer Höhe
                SizedBox(
                  height: 400, // Feste Höhe für den unteren Bereich
                  child: Row(
                    children: [
                            ...
                            child: Padding(
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  // Quick Stats
                                  _buildStatRow('🗓️', 
                                      context.isGerman ? 'Nächstes Event' : 'Next Event', 
                                      event != null 
                                        ? '${event.date.day}.${event.date.month}'
                                        : (context.isGerman ? 'Keins' : 'None')),
                                  const SizedBox(height: 8),
                                  _buildStatRow('👥', 
                                      context.isGerman ? 'Zusagen' : 'Confirmations', 
                                      event != null 
                                        ? '${event.yesCount}/4'
                                        : '-'),
                                  const SizedBox(height: 8),
                                  _buildStatRow('🎯', 
                                      context.isGerman ? 'Status' : 'Status', 
                                      event != null && event.isConfirmed
                                        ? (context.isGerman ? 'Bestätigt' : 'Confirmed')
                                        : (context.isGerman ? 'Offen' : 'Open')),
